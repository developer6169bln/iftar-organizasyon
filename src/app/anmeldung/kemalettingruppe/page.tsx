...
function KemalettingruppeAnmeldungContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/registrations/kemalettingruppe', {
        method: 'POST',
      ...
      if (data.participating && data.acceptToken) {
        ...
        window.location.href = `/anmeldung/kemalettingruppe/erfolg?${params.toString()}`
        return
      }
      setSuccess(true)
      setFirstName('')
      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-amber-50 to-orange-50 p-4">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl text-center">
          ...
          <p className="text-gray-600">
            Ihre Anmeldung für die Kemalettingruppe wurde erfolgreich übermittelt. Wir freuen uns auf Ihre Teilnahme.
          </p>
          <button
            type="button"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-amber-50 to-orange-50 p-4">
      <div className="anmeldung-form w-full max-w-lg rounded-2xl bg-white p-8 shadow-xl">
        <h1 className="mb-2 text-center text-3xl font-bold text-gray-900">Kemalettingruppe</h1>
        <p className="mb-6 text-center text-gray-600">
          Registrierung für die Kemalettingruppe – Teilnahme am Event bekunden
        </p>
        ...
        <div className="mt-4 flex items-center justify-center gap-2">
          <input
            type="text"
            readOnly
            value={shareUrl || '/anmeldung/kemalettingruppe'}
...
export default function KemalettingruppeAnmeldungPage() {
  return (
    <Suspense fallback={<div className="flex min-h-screen items-center justify-center bg-amber-50 p-4"><p className="text-gray-600">Lade …</p></div>}>
      <KemalettingruppeAnmeldungContent />
    </Suspense>
  )
}
