...
function OmerlisteErfolgContent() {
        ...
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl text-center">
          ...
          <a
            href={(() => {
              ...
              return eid ? `/anmeldung/omerliste?eventId=${encodeURIComponent(eid)}` : '/anmeldung/omerliste'
            })()}
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-amber-50 to-orange-50 p-4">
      <div className="w-full max-w-lg rounded-2xl bg-white p-8 shadow-xl">
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          ...
          <a
            href={eventId ? `/anmeldung/omerliste?eventId=${encodeURIComponent(eventId)}` : '/anmeldung/omerliste'}
...
export default function OmerlisteErfolgPage() {
  return (
    <Suspense fallback={<LoadingFallback />}>
      <OmerlisteErfolgContent />
    </Suspense>
  )
}
