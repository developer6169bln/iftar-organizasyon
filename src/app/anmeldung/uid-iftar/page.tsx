...
export default function UidIftarAnmeldungPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true)
    try {
      const res = await fetch('/api/registrations/uid-iftar', {
        method: 'POST',
      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-amber-50 to-orange-50 p-4">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl text-center">
          ...
          <p className="text-gray-600">
            Ihre Anmeldung für den UID Iftar wurde erfolgreich übermittelt. Wir freuen uns auf Ihre Teilnahme.
          </p>
          <button
            type="button"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-amber-50 to-orange-50 p-4">
      <div className="anmeldung-form w-full max-w-lg rounded-2xl bg-white p-8 shadow-xl">
        <h1 className="mb-2 text-center text-3xl font-bold text-gray-900">UID IFTAR</h1>
